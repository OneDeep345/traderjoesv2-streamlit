        ...
        for symbol in symbols:
            ...
            while self.is_running:
                try:
                    ...
                    # Check exits with trailing TP every second
                    await self.check_exits_with_trailing()
                    
                    # Full UI update every second for guaranteed 1Hz refresh
                    await self.update_ui_full()
                    
                    # Scan markets every 6 seconds
                    if self.update_counter % 12 == 0:
                        self.scan_count += 1
